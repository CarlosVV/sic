namespace Nagnoi.SiC.Web.Models.Paging
{
    ...
    public class DataTableParam
    {
        ...
        public string EnsureSortOrder()
        {
            string descending = SortOrder.EndsWith("DESC", StringComparison.InvariantCultureIgnoreCase) ? "descending" : string.Empty;

            return string.Format("{0} {1}", SortOrder, descending);
        }
